...
void SLAVE_DEVICE_init__(SLAVE_DEVICE *data__, BOOL retain) {
  __INIT_VAR(data__->SEND_SLAVE,0,retain)
  __INIT_VAR(data__->RECIEVE_SLAVE,0,retain)
...
void SLAVE_DEVICE_body__(SLAVE_DEVICE *data__) {
  ...
  __SET_VAR(data__->TON0.,IN,,(!(__GET_VAR(data__->SEND_SLAVE,)) && !(__GET_VAR(data__->SWITCH,))));
  ...
  __SET_VAR(data__->,SWITCH,,__GET_VAR(data__->TOF0.Q,));
  __SET_VAR(data__->TON1.,EN,,__BOOL_LITERAL(TRUE));
  __SET_VAR(data__->TON1.,IN,,(!(__GET_VAR(data__->RECIEVE_SLAVE,)) && !(__GET_VAR(data__->LED,))));
  __SET_VAR(data__->TON1.,PT,,__time_to_timespec(1, 1000, 0, 0, 0, 0));
  TON_body__(&data__->TON1);
  __SET_VAR(data__->TOF1.,EN,,__GET_VAR(data__->TON1.ENO,));
  ...
  __SET_VAR(data__->,LED,,__GET_VAR(data__->TOF1.Q,));
